          ...
          <div className="-space-y-px rounded-md shadow-sm">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="relative block w-full rounded-t-md border-0 px-2 py-1.5 ring-1 ring-inset focus:z-10 focus:ring-2"
            ...
            <div>
              ...
              <input
                ...
                required
                className="relative block w-full rounded-b-md border-0 px-2 py-1.5 ring-1 ring-inset focus:z-10 focus:ring-2"
